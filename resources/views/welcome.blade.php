...
<div class="container">
   <div class="row">
     ...
     <div class="col-4">
            ...
            <p> Bienvenue sur notre site « Projet Reservation » </p>

          <p> Sur notre site vous pourrez voir le catalogue des différents spectacles disponible, vous pourrez également acheter vos places. </p> Pour pouvoir réserver un spectacle vous devez être inscrit sinon vous n’avez qu’accès que à notre catalogue. </p>
        </br>
      </div>
  </div>
</div>
